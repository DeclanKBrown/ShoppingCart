        ...
        <main className='min-h-[89vh] py-16'>
            <div className="grid grid-cols-2">
                ...
                <div className='flex flex-col px-16 pr-80'>
                    ...
                    <input type="number" className='border border-black mb-8 pl-4 w-20' min='1' max='5' value={qty} onChange={(e) => {setQty(e.target.value)}}/>
                    <button className='p-4 border border-black mb-6' onClick={() => addToCart(item, qty)}>Add To Cart</button>
